...
public class ProjectSelectionViewModel : ViewModelBase
{
    ...
    private void InitializeProject()
    {
        ...
        ProjectConfig.ProjectImageWatchers = new List<ImageFileWatcher>();
        foreach (var path in ProjectConfig.ImgDirectoryPaths)
        {
            var watcher = new ImageFileWatcher(path);
            watcher.ImageWatcher.Renamed += ProjectConfig.InputImageChangeEvent;
            watcher.ImageWatcher.Created += ProjectConfig.InputImageChangeEvent;
            watcher.ImageWatcher.Deleted += ProjectConfig.InputImageChangeEvent;
